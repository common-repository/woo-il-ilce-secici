jQuery( function($) {
  ...
  if ( typeof wc_country_select_params === 'undefined' || typeof wc_il_ilce_sec_params === 'undefined' ) {
    return false;
  }
  ...
  if ( $().select2 ) {
    var wc_il_ilce_sec_select2 = function() {
    ...
    wc_il_ilce_sec_select2();

    $( document.body ).bind( 'secilecek_sehir', function() {
      wc_il_ilce_sec_select2();
    });
  }

  /* City select boxes */
  var cities_json = wc_il_ilce_sec_params.sehirler.replace( /&quot;/g, '"' );
  ...
  function cityToSelect( $citybox, current_cities ) {
    ...
    $citybox.html( '<option value="">' + wc_il_ilce_sec_params.i18n_select_city_text + '</option>' + options );
    ...
    $( document.body ).trigger( 'secilecek_sehir' );
  }
});